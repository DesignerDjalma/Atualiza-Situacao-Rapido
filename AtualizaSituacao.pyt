...
def atualizarDQeAplicarZoom(mxd, lista):
    """Atualiza o mapa de situacao de acordo com as 
    entradas fornecidas (1 ou mais): EX.:
    att_situacao('BELÉM','ACARÁ',...)"""

    UNICODES_LOWERCASE = ['\xc3\xa1','\xc3\xa9','\xc3\xad','\xc3\xb3','\xc3\xba','\xc3\xa3','\xc3\xb5','\xc3\xa2','\xc3\xaa','\xc3\xae','\xc3\xb4','\xc3\xbb','\xc3\xa7',]
    UNICODES_UPPERCASE = ['\xc3\x81','\xc3\x89','\xc3\x8d','\xc3\x93','\xc3\x9a','\xc3\x83','\xc3\x95','\xc3\x82','\xc3\x8a','\xc3\x8e','\xc3\x94','\xc3\x9b','\xc3\x87',]
    DEFINITION_QUERY_SITUACAO = {1:"{}nmSede = \'{}\'",2:"{}nmMun <> \'{}\'",3:"{}nmMun = \'{}\'",}

    cmds = arcpy.mapping.ListLayers(mxd)
    P, UNI, uni = DEFINITION_QUERY_SITUACAO, UNICODES_UPPERCASE, UNICODES_LOWERCASE
    fz, df, EXP, municipio = 1.084556648631034, False, ['1', '2', '3'], tuple(lista)
...
class AtualizaSituacao(object):
    ...
    def getParameterInfo(self):
        return [arcpy.Parameter(displayName=texto('Município'),name='municipio',**Argumentos.pString)]
    ...
    def execute(self, parameters, messages):
        ...
        atualizarDQeAplicarZoom(mxd, true_list)
